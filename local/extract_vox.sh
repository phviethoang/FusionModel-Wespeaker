...
data_name_array=("voxceleb1" "voxceleb1_test")
data_list_path_array=("${data}/voxceleb1/${data_type}.list" "${data}/voxceleb1_test/${data_type}.list")
data_scp_path_array=("${data}/voxceleb1/wav.scp" "${data}/voxceleb1_test/wav.scp") # to count the number of wavs
nj_array=($nj $nj)
...
# data_name_array=("voxceleb1_test")
# data_list_path_array=("${data}/voxceleb1_test/${data_type}.list")
# data_scp_path_array=("${data}/voxceleb1_test/wav.scp") # to count the number of wavs
# nj_array=($nj)
